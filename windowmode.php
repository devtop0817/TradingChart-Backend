<?php
    ...
    if(sqlsrv_has_rows($templates)) {
        $updatequery = "UPDATE [csvdatasminichart].[dbo].[usermode] SET script='".$script."' WHERE userid = '".$userid."'"; 
        ...
        $insertquery = "INSERT INTO [csvdatasminichart].[dbo].[usermode] (userid, script) VALUES('".$userid."', '".$script."')";
